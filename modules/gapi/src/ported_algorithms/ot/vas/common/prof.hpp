...
#ifndef OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_PROF_HPP
#define OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_PROF_HPP
...
#endif // OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_PROF_HPP
