...
#ifndef OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_KALMAN_FILTER_NO_OPENCV_HPP
#define OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_KALMAN_FILTER_NO_OPENCV_HPP
...
#endif // OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_KALMAN_FILTER_NO_OPENCV_HPP
