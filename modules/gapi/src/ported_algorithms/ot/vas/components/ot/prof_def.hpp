...
#ifndef OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_PROF_DEF_HPP
#define OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_PROF_DEF_HPP

#include "ported_algorithms/ot/vas/common/prof.hpp"
