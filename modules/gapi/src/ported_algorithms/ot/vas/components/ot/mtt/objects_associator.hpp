...
#ifndef OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_OBJECTS_ASSOCIATOR_HPP
#define OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_OBJECTS_ASSOCIATOR_HPP
...
#endif // OPENCV_GAPI_PORTED_ALGORITHMS_VAS_OT_OBJECTS_ASSOCIATOR_HPP
