...
#ifndef OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_HPP
#define OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_HPP
...
#endif // OPENCV_GAPI_PORTED_ALGORITHMS_VAS_COMMON_HPP
